    ...
    >
      <Headless.Input
        ...
        className={clsx([
          ...
          // Basic layout
          'relative block w-full appearance-none rounded-md px-[calc(theme(spacing[3.5])-1px)]',
          // Disable by Vanlt //'py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing[3])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)]',
          // Typography
