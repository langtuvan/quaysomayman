  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      <Button
        ...
        color="white"
        variant="secondary"
        //href={`${AUTH0_API.googleAuth}`}
        onClick={() => handleLogin(`${AUTH0_API.googleAuth}`)}
        className="w-full cursor-pointer space-x-3 active:scale-95 active:bg-gray-500"
      >
      ...
      {/* <Button
        disabled={!facebook}
        color="blue"
        //href={`${AUTH0_API.facebookAuth}`}
        onClick={() => handleLogin(`${AUTH0_API.facebookAuth}`)}
