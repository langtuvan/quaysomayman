...
export function TextLink({
  ...
  return (
    <Link
      ...
      className={clsx(
        className,
        'text-zinc-950 decoration-zinc-950/50 hover:underline data-[hover]:decoration-zinc-950 dark:text-white dark:decoration-white/50 dark:data-[hover]:decoration-white',
      )}
    />
  )
}
