...
export function TableHead({
  ...
  return (
    <thead
      ...
      className={clsx(
        className,
        //'bg-zinc-100 text-zinc-500 dark:text-zinc-950',
      )}
    />
  )
}
  ...
  return (
    ...
    >
      <tr
        {...props}
        className={clsx(
          'hover:bg-orange-50 active:bg-orange-200', // custom by Vanlt
          className,
          href &&
...
const TableHeaderStyles =
  'sticky top-0 z-10 border-gray-300 bg-indigo-400 text-white backdrop-blur backdrop-filter'
